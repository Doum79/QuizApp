...
namespace Parcha.Data
{
    public static class DbSeeder
    {
        ...
        private static void CreateQuizzes(ApplicationDbContext dbContext)
        {
            ...
            "to adhere to the principles of the light side of them   Force " + "or if you're fated to embrace the dark side. " + "No you want to become a true JEDI, you can't possibly miss this!",
                ViewCount = 2343,
                CreatedDate = createdDate,
                LastModifiedDate = lastModifiedDate
            });
            ...
            EntityEntry<Quiz> e3 = dbContext.Quizzes.Add(new Quiz()
            {
                ...
                Text = @"Do you relentlessly seek revenge like Eren? " + "Are you willing to put your like on the stake to protect your friends like Mikasa ? " +

            "Would you trust your fighting skills like Levi " +
            "or rely on your strategies and tactics like Arwin? " + "Unveil your true self with this Attack On Titan personality test!",
                CreatedDate = createdDate,
                LastModifiedDate = lastModifiedDate,
                ViewCount = 5203
            });
         ...
         DateTime createdDate)
        {
            var quiz = new Quiz()
            {
                ...
                Text = "testing purposes. " + "All the questions, answers & results are auto-generated as well.",
                ViewCount = viewCount,
                CreatedDate = createdDate,
